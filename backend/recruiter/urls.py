...
from .views import CompanyProfileAPIView, JobListCreateAPIView, JobDetailAPIView, CompanyProfileDetailView, JobApplicationListCreateAPIView
...
urlpatterns = [
    ...
    path('job-applications/', JobApplicationListCreateAPIView.as_view(), name='job-application-list-create'),
]
